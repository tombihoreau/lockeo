  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        final baseProducts = snapshot.data![0] as List<Product>;
          ...
          builder: (context, favoriteIds, _) {
            ...
            var validOffers = visibleOffers
                .where(
                  (offer) => products.any(
                    (product) =>
                        product.productId == offer.productId &&
                        product.isAvailable,
                  ),
                )
                .toList();
            ...
            if (widget.randomize) {
              ...
              validOffers.sort(
                (a, b) => _randomizedOfferIds
                    .indexOf(a.offerId)
                    .compareTo(_randomizedOfferIds.indexOf(b.offerId)),
              );
            }
